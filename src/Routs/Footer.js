...
export const Footer = () => {
  return (
    <CDBFooter className="shadow" style={{backgroundColor:"black", opacity:"0.95"}}>
      <CDBBox
        display="flex"
        ...
        <CDBBox display="flex" alignItems="center">
          <a href="/" className="d-flex align-items-center p-0 text-dark">
            <img
              ...
              width="30px"
            />
            <span className="ml-4 h5 mb-0 font-weight-bold" style={{color:"white"}}>Matin Website</span>
          </a>
        </CDBBox>
        <CDBBox>
          <small className="ml-2" style={{color:"white"}}>&copy; MatinWebsite, 2022. All rights reserved.</small>
        </CDBBox>
        <CDBBox display="flex">
